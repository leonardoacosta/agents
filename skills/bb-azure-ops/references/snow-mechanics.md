...
```bash
~/dev/brown/wholesale/scripts/snow-refresh                # refresh /tmp/snow-cookies.txt
~/dev/brown/wholesale/scripts/snow-refresh test           # full E2E verification
~/dev/brown/wholesale/scripts/snow-refresh start          # spawn Edge CDP without extracting (first-run setup)
~/dev/brown/wholesale/scripts/snow-refresh stop           # kill the CDP Edge instance
~/dev/brown/wholesale/scripts/snow-refresh print          # extract and print to stdout (skip file write)
