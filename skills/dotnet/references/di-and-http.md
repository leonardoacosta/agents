...
Never hardcode a PAT, client secret, or connection string. Keep environment-specific managed
identity, subscription, RBAC, and local network-access rules in the repository's operations overlay.
