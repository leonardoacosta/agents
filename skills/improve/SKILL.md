---
name: improve
description: "Survey a codebase and produce prioritized implementation plans for other agents. Use when asked to audit a codebase."
license: MIT
metadata:
  author: shadcn
  version: "1.0.0"
...
Audit the codebase across the categories in [references/audit-playbook.md](/home/nyaptor/.agents/skills/improve/references/audit-playbook.md) — read it now. Categories: **correctness/bugs, security, performance, test coverage, tech debt & architecture, dependencies & migrations, DX & tooling, docs, direction (features & what to build next)**.
...
For each selected finding, write one plan file using the template in [references/suggestion-template.md](/home/nyaptor/.agents/skills/improve/references/suggestion-template.md) — read it before writing the first plan. Plans go in:
